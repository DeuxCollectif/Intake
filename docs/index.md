...
### Data Model
[**View Data Model**](https://github.com/KevinDeuxCollectif/Intake/blob/main/specs/1-estimate-risk-agent/data-model.md)  
Entity definitions, relationships, and data structures powering the system.
...
Detailed breakdown of all work items and deliverables.
